...
export function NavLink({
  ...
  return (
    <a
      ...
      className={`inline-flex h-[var(--height-nav-link)] items-center rounded-[var(--radius-pill)] px-4 font-mono text-nav uppercase transition-colors duration-150 ease-out ${
